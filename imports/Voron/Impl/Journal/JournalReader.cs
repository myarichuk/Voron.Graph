...
namespace Voron.Impl.Journal
{
    public unsafe class JournalReader
    {
        ...
        private static void ValidateHeader(TransactionHeader* current, TransactionHeader* previous)
        {
        ...
        {
            var crc = Crc.Value(_pager.AcquirePagePointer(_readingPage), 0, compressedPages * options.PageSize);
